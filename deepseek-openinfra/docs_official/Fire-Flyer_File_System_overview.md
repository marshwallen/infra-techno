...
![Large block read throughput under stress test on a 180-node cluster](figures/peak_throughput.jpg)
...
![](figures/gray_sort_server.png)
![](figures/gray_sort_client.png)
...
![KVCache Read Throughput](./figures/kvcache_read_throughput.png)
![KVCache GC IOPS](./figures/kvcache_gc_iops.png)
